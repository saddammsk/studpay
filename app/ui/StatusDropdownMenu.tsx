...
function DropdownMenu({ label, items }: DropdownMenuProps) {
     return (
          <div className="w-full">
               <Menu>
                    <MenuButton className="inline-flex items-center justify-between min-w-37.5 w-full gap-2 rounded-lg border border-gray54 bg-white px-3 h-10 text-sm font-normal text-black-1200 font-inter">
