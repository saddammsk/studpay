...
function DropdownMenu({ label, items }: DropdownMenuProps) {
     return (
          <div className="w-full">
               <Menu>
                    <MenuButton className="inline-flex items-center justify-between xl:min-w-37.5 min-w-32.5 w-full gap-2 rounded-[10px] border border-gray55 bg-white px-3 h-9 text-sm font-normal text-black-1200 font-inter">
                         {label} <img src="/images/down-arrow.svg" alt="" />
                    </MenuButton>
                    <MenuItems
