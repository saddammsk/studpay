...
const plans = [
     ...
     {
          checkboximg: '/images/file-icon.svg', name: 'Lease & Contracts', des: 'Create, sign, and manage lease agreements with built-in e-signature support.'
     },
     {
                    ...
                    <div className="h-screen flex items-center justify-center">
                         <div className='w-full max-w-[672px]'>
                              <div className="flex items-center justify-between">
                                   <h6 className="text-sm font-normal font-inter leading-5 text-gray-1400">Step 3 of 4</h6>
                                   <h6 className="text-sm font-normal font-inter leading-5 text-gray-1400">80%</h6>
                              </div>
                              ...
                              <div className="text-center">
                                   <h4 className='text-[36px] font-medium leading-10 mb-2 text-black-1000 tracking-[-0.5px]'>What features do you need?</h4>
                                   <p className='mt-1 text-base font-normal leading-6 text-gray-1400'>Select the tools that match your workflow. You can always change these later.</p>
                              </div>
                              <form action="" className='mt-9'>
                                   <RadioGroup by="name" value={selected} onChange={setSelected} aria-label="Server size" className="mb-8 grid md:grid-cols-2 gap-x-2 gap-y-4 space-y-2">
                                        {plans.map((plan) => (
                                             <Radio
                                                  key={plan.name}
                                                  value={plan}
                                                  className="group relative border border-gray-1300 cursor-pointer rounded-[12px] bg-gray-1600 p-4 transition focus:not-data-focus:outline-none data-checked:bg-white/10 data-focus:outline data-focus:outline-white"
                                             >
                                   ...
                                   <div className='flex mt-12 items-center justify-between'>
                                        <Link href="/" className="text-sm px-8 font-normal gap-2 flex items-center leading-5 text-black-1000">
                                             <img src="/images/left-icon.svg" alt="" />    Back
                                        </Link>
                                        <PrimaryLink href="/login" className="opacity-50 min-w-[148px] !w-fit pointer-events-none" variant="primary">
