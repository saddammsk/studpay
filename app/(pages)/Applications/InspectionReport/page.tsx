     ...
     return (
          <div className="xl:py-6 xl:pl-8 4xl:pr-10 xl:px-4 p-4">
               <div className="mb-4 flex flex-wrap gap-2 items-end justify-between">
                    <div>
                         <Link href="/Applications" className="flex items-center py-2 text-sm mb-1.5 font-medium gap-2 text-gray-1000"><img src="/images/left-arrow.svg" alt=""></img> Back to Applications</Link>
