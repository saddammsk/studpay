      ...
      <div className="lg:p-6 p-4">
        ...
        <div className="p-3 mt-3 bg-white">
          ...
          <div className="mt-6">
            ...
            <div className="mt-8">
              <div className="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 2xl:gap-x-12.5 lg:gap-x-6 lg:gap-y-6 gap-4">
                <div className="border border-solid border-gray54 rounded-xl lg:p-6 p-4">
                  <span className="text-gray-1400 font-medium mb-3 text-sm leading-5 tracking-[-0.35px] flex items-center gap-2">
                    <Image
                  ...
                  <h4 className="text-black15 font-bold text-2xl leading-8 font-inter">
                    $1,850.00
                  </h4>
                </div>
                <div className="border border-solid border-gray54 rounded-xl lg:p-6 p-4">
                ...
                <div className="border border-solid border-gray54 rounded-xl lg:p-6 p-4">
                  ...
                  <h4 className="text-black15 font-medium lg:text-lg text-base leading-7 font-inter mb-1">
                    Auto-pay (Bank Transfer)
                  </h4>
                  <span className="text-green12 font-normal text-sm font-inter leading-5">
                    Active
                  </span>
                </div>
                <div className="border border-solid border-gray54 rounded-xl lg:p-6 p-4">
                ...
                <div className="sm:col-span-2 border border-solid border-gray54 rounded-xl lg:p-6 p-4">
                  <span className="text-gray-1400 font-medium mb-3 text-sm leading-5 tracking-[-0.35px] flex items-center gap-2">
                    <Image
                  ...
                  <h4 className="text-black15 font-medium text-lg leading-7 font-inter">
                    Michael Johnson
                  </h4>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-1400 font-inter font-normal text-sm leading-5 block">
                      Father
                    </span>
