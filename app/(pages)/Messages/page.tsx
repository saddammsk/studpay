    ...
    <>
      <div className="">
        <div className="flex relative overflow-hidden">
          <div className="xl:static absolute -left-full top-0 xl:h-auto h-full 2xl:max-w-85 xl:max-w-70 max-w-full w-full bg-white z-1 border-r border-l border-solid border-gray45">
          ...
          <div className="relative flex items-center justify-between flex-col bg-blue138 flex-1 w-full">
            ...
            <div className="w-full flex-1 p-4">
              <div className="mb-4">
                ...
                <div className="bg-gray562 rounded-2xl inline-flex flex-col py-3 px-4">
                  <h4 className="text-black font-normal font-inter text-sm leading-[22.8px]">
                    Hello! I am very interested in your studio. Is it still
              ...
              <div className="mb-4">
                ...
                <div className="bg-gray562 rounded-2xl inline-flex flex-col py-3 px-4">
                  <h4 className="text-black font-normal font-inter text-sm leading-[22.8px]">
                    I am a graduate student at Sorbonne University and I am
              ...
              <div className="mb-4 flex items-center justify-end">
                <div className="bg-blue139 rounded-2xl inline-flex flex-col py-3 px-4">
                  <h4 className="text-black font-normal font-inter text-sm leading-[22.8px]">
                    Bonjour Sarah, oui le studio est toujours disponible. Je
                    serais ravi de vous le faire visiter.{" "}
                  </h4>
                  <div className="flex items-center justify-between mt-2">
                    <span className="text-gray37 font-inter font-normal text-[10px] leading-3.75 block">
                      19:12
