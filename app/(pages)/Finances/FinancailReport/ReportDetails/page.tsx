                    ...
                    <div className="xl:px-6 md:px-3 px-4 flex items-center justify-between">
                         <div className="">
                              ...
                              <ul className="flex items-center gap-2.5">
                                   ...
                                   <li>
                                        <h6 className="text-black-1000 font-dm-sans font-normal md:text-sm text-xs leading-5">Reports details</h6>
                                   </li>
                              </ul>
                         </div>
               ...
               <div className="xl:py-6 xl:pl-8 4xl:pr-10 xl:px-4 p-4">
                    <div className="flex items-center lg:gap-0 gap-5 lg:flex-nowrap flex-wrap sm:gap-0 gap-4 justify-between ">
                         <div className="flex items-center gap-4">
                              <Link href="/" className="flex items-center justify-center w-10 h-10"><img src="/images/left-arrow2.svg" alt="" /></Link>
                              <div>
                                   <h4 className="text-lg font-bold leding-8 text-black-1500 mb-1">Annual Summary</h4>
