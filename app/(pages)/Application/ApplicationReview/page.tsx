                         ...
                         <TabPanels className="mt-6">
                                   ...
                                   <div className="grid lg:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                             ...
                                             <ul className="flex items-center my-8 justify-center gap-3 max-w-[604px] mx-auto">
                                                  <li className="w-1/2">
                                                       <Buttons type="submit" className="px-4 !py-2.5 gap-2.5 bg-green-1300!" variant="primary">
                                                            Approve Application
                                                       </Buttons>
                                                  </li>
                                                  <li className="w-1/2">
                                                       <Buttons type="submit" className="px-4 !py-2.5 gap-2.5 bg-transparent! border border-red-1100 text-red-1100!" variant="primary">
                                                            Reject Application
                                                       </Buttons>
                                                  </li>
                                             </ul>
                                   ...
                                   <div className="my-6">
                                        <form action="">
                                             <div className="flex items-end flex-wrap gap-3">
                                                  ...
                                                  <Buttons type="submit" className="px-4 mb-5 !py-2 w-fit! gap-2.5  border border-gray-1100!" variant="default">
                                                       <img src="/images/filter-icon.svg" alt="" /> Filter
                                                  </Buttons>
                                                  <Buttons type="submit" className="px-4 mb-5 !py-2 w-fit! gap-2.5 " variant="primary">
                                   ...
                                   <div className="grid xl:grid-cols-3 md:grid-cols-2 mt-8 gap-6">
                                        <div className="bg-white border border-gray-1100 rounded-lg shadow-6xl pt-6 pb-[30px] px-5">
                                             ...
                                             <form action="" className="w-fit mx-auto ">
                                                  ...
                                                  <Buttons type="submit" className="px-4 !py-2.5 font-medium gap-2.5 !text-black opacity-50 border border-gray-1100!" variant="default">
                                        ...
                                        <div className="bg-white border border-gray-1100 rounded-lg shadow-6xl pt-6 pb-[30px] px-5">
                                             ...
                                             <form action="" className="max-w-[302px] mx-auto ">
                                                  ...
                                                  <textarea name="" id="" placeholder="Add context for the applicant..." className="text-sm font-inter mb-1 font-normal leading-5 text-gray-1000 placeholder:text-gray-1000 w-full px-[13px] py-[9px] h-20 rounded-md border border-gray-1100"></textarea>
                                                  <Buttons type="submit" className="px-4 !py-2.5 font-medium gap-2.5 !text-red-1200 opacity-50 border border-red-1300!" variant="default">
                                        ...
                                        <div className="bg-white shadow-13xl border border-gray-1100 rounded-lg shadow-6xl pt-6 pb-[30px] px-5">
                                             <div className="max-w-[360px] mx-auto">
                                                  ...
                                                  <Buttons type="submit" className="px-4 !py-2.5 font-medium gap-2.5 !text-white " variant="primary">
                              ...
                              <TabPanel>
                                   <div className="flex items-center flex-wrap gap-5 justify-between mb-8">
                                        ...
                                        <div className="w-fit">
                                             <Buttons type="submit" className="px-4 !py-2.5 font-medium gap-2" variant="primary">
                                   ...
                                   <div className="flex xl:flex-nowrap flex-wrap gap-4">
                                        ...
                                        <div className="xl:w-4/12 w-full">
                                             ...
                                             <Buttons type="submit" className="px-4 !py-2.5  gap-2.5 " variant="primary">
                                                  <img src="/images/send-icon.svg" className="invert-[1]" alt="" /> Send for Signature
                                             </Buttons>
                                             <ul className="flex gap-3 mt-3">
                                                  <li className="w-1/2">
                                                       <Buttons type="submit" className="px-4 !py-2.5 gap-2.5  border border-gray-1100!" variant="default">
